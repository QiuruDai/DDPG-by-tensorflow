...
class DDPG(object):
    ...
    def __init__(self, actor, critic, memory, observation_shape, action_shape,
                 actor_lr=1e-4, critic_lr=1e-3, batch_size=128,
    ...
    def setup_actor_optimizer(self):
        ...
        self.actor_train = self.actor_optimizer.minimize(self.actor_loss, global_step = self.global_step, var_list=self.actor.trainable_vars)
    ...
    def setup_critic_optimizer(self):
        ...
        self.critic_train = self.critic_optimizer.minimize(self.critic_loss, var_list=self.critic.trainable_vars)
