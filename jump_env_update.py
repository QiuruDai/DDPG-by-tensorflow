...
class Data_Env(object):
    def __init__(self):
        self.observation_shape = (60,60,1)
        self.action_shape = (1,)
...
class Save_Env(object):
    def __init__(self, save_dir, number_templet, restart_templet, threshold=0.95):
        self.observation_shape = (60, 60, 1)
        self.action_shape = (1,)
    ...
    def get_screenshot(self, file_name):
        os.system('adb shell screencap -p /sdcard/0.jpg')
        os.system('adb pull /sdcard/0.jpg %s' % file_name)
    ...
    def reset(self):
        ...
        #        print('Please reset the game!!!')
        # get state
        file_name = self.save_dir + get_time() + ".jpg"
    ...
    def step(self, action):
        ...
        if self.restart(file_name):
            ...
            reward = 1
            score = self.get_score(file_name)

        return obs, reward, done, score, file_name
